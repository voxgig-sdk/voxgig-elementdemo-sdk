# Elementdemo SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions ElementdemoSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both ElementdemoSDK(...) and ElementdemoSDK.test(...) become
#      ElementdemoSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "elementdemo_sdk"
_SDK_CLASS = "ElementdemoSDK"
