# Elementdemo SDK secrets feature
...
from elementdemo_sdk.feature.secrets.voxgig_sekreto import Sekreto, envkey
...
from elementdemo_sdk.config import FEATURE_PLUGINS
...
class ElementdemoSecretsFeature(ElementdemoBaseFeature):
    def __init__(self):
        super().__init__()
        self.version = "0.1.0"
        self.name = "secrets"
    ...
    def init(self, ctx, fopts):
        ...
        # Seam for ElementdemoSDK.prepare() (no feature hooks on that
