# Elementdemo SDK context

from __future__ import annotations
import random

from elementdemo_sdk.utility.voxgig_struct import voxgig_struct as vs
from elementdemo_sdk.core.control import ElementdemoControl
...
from elementdemo_sdk.core.helpers import get_ctx_prop, to_map


class ElementdemoContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(sp, ElementdemoSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, ElementdemoResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, ElementdemoResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return ElementdemoError(code, msg, self)
