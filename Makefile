# Elementdemo SDK deployment. GENERATED by @voxgig/sdkgen — regenerated
...
deploy-bash:
	boru vault exec --for=github=$(GITHUB_ALIAS) -- $(MAKE) -C bash publish

deploy-dry-bash:
	boru vault exec --dry-run --for=github=$(GITHUB_ALIAS) -- $(MAKE) -C bash publish
