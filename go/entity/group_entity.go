...
func NewGroupEntity(client *core.ElementdemoSDK, entopts map[string]any) *GroupEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *GroupEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
