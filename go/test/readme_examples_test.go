...
const testSeed = `map[string]any{"entity": map[string]any{"element": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "group": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "isotope": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "series": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
