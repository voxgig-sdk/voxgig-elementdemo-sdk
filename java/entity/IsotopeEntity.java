...
/** Isotope entity client for the Elementdemo SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class IsotopeEntity extends EntityBase {

  public IsotopeEntity(SdkClient client, Map<String, Object> entopts) {
    super("isotope", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new IsotopeEntity(this.client, opts);
  }
