...
/** Group entity client for the Elementdemo SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class GroupEntity extends EntityBase {

  public GroupEntity(SdkClient client, Map<String, Object> entopts) {
    super("group", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new GroupEntity(this.client, opts);
  }
