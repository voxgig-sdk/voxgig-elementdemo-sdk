package voxgig.elementdemosdk.entity;
...
import voxgig.elementdemosdk.core.SdkClient;
import voxgig.elementdemosdk.utility.struct.Struct;

/** Element entity client for the Elementdemo SDK. */
@SuppressWarnings({"unchecked", "unused"})
public class ElementEntity extends EntityBase {

  public ElementEntity(SdkClient client, Map<String, Object> entopts) {
    super("element", client, entopts);
  }

  @Override
  public Entity make() {
    Map<String, Object> opts = new LinkedHashMap<>(this.entopts);
    return new ElementEntity(this.client, opts);
  }
