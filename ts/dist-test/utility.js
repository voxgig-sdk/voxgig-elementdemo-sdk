...
function envOverride(m) {
    if ('TRUE' === process.env.ELEMENTDEMO_TEST_LIVE ||
        'TRUE' === process.env.ELEMENTDEMO_TEST_OVERRIDE) {
    ...
    m.ELEMENTDEMO_TEST_EXPLAIN = process.env.ELEMENTDEMO_TEST_EXPLAIN || m.ELEMENTDEMO_TEST_EXPLAIN;
    return m;
}
