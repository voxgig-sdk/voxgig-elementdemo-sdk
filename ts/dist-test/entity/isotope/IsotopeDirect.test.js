...
(0, node_test_1.describe)('IsotopeDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-isotope', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-isotope', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["element01"]))
            return;
    ...
    (0, node_test_1.test)('direct-list-isotope', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-isotope', setup.live))
            return;
        if ((0, utility_1.skipIfMissingIds)(t, setup, ["element01"]))
            return;
        const { client, calls } = setup;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ELEMENTDEMO_TEST_ISOTOPE_ENTID'];
...
//# sourceMappingURL=IsotopeDirect.test.js.map