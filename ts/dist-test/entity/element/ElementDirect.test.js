...
(0, node_test_1.describe)('ElementDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-element', async (t) => {
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-element', setup.live))
            return;
    ...
    (0, node_test_1.test)('direct-list-element', async (t) => {
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-element', setup.live))
            return;
        const { client, calls } = setup;
        const params = {};
        const query = {};
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['ELEMENTDEMO_TEST_ELEMENT_ENTID'];
...
//# sourceMappingURL=ElementDirect.test.js.map