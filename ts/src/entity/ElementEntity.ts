...
class ElementEntity extends ElementdemoEntityBase<Element> {
  ...
  make(this: ElementEntity) {
    return new ElementEntity(this._client, this.entopts())
  }



  async load(this: any, reqmatch?: ElementLoadMatch, ctrl?: Control): Promise<ElementEntity> {
  ...
  async list(this: any, reqmatch?: ElementListMatch, ctrl?: Control): Promise<ElementEntity[]> {
  ...
  async create(this: any, reqdata?: ElementCreateData, ctrl?: Control): Promise<ElementEntity> {
  ...
  async update(this: any, reqdata?: ElementUpdateData, ctrl?: Control): Promise<ElementEntity> {
  ...
  async remove(
    this: any, reqmatch?: ElementRemoveMatch, ctrl?: Control,
    ...
    try {
      ...
      if (err) {
        ...
        // Off-happy-path (throw disabled): typed as any so the method's
        // Promise<ElementEntity> return stays clean under strict null checks.
        return undefined as any
      }
    }
  }
