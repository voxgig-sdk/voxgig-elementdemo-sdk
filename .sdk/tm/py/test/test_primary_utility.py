# Elementdemo SDK primary utility test
...
from projectname_sdk import ElementdemoSDK
from projectname_sdk.core.spec import ElementdemoSpec
from projectname_sdk.core.result import ElementdemoResult
from projectname_sdk.core.response import ElementdemoResponse
from projectname_sdk.core.operation import ElementdemoOperation
from projectname_sdk.core.error import ElementdemoError
from projectname_sdk.core import helpers
from projectname_sdk.feature.base_feature import ElementdemoBaseFeature
...
def _err_from_map(m):
    ...
    if msg == "":
        return None
    code = m.get("code", "")
    return ElementdemoError(code, msg)
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = ElementdemoSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = ElementdemoSDK.test(None, None)
        ...
        class TestInitFeature(ElementdemoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(ElementdemoBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_result_no_result(self):
        ...
        utility = client._utility
        ctx = _make_test_full_ctx(client, utility)
        ctx.spec = ElementdemoSpec({"step": "start"})
        ctx.result = None
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = ElementdemoSDK.test(None, setup_opts)
    ...
    def test_operator_basic(self):
        ...
        def subject(entry):
            ...
            if not isinstance(in_val, dict):
                in_val = {}
            op = ElementdemoOperation(in_val)
            return {
                "entity": op.entity,
                "name": op.name,
                "input": op.input,
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = ElementdemoSDK.test(None, setup_opts)
