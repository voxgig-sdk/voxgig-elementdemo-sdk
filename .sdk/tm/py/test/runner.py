...
class ElementdemoTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = ElementdemoTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = ElementdemoTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = ElementdemoTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
