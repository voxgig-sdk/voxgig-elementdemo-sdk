...
// PROJECT-ADDITIVE components, resolved per target as cmp/<t>/Examples_<t>
// and skipped where a target ships none. This is the supported extension
// route: `doctor` reports the component files as additive, and a
// `target add` resync leaves them alone. Only the ts target provides one
// here (src/cmp/ts/Examples_ts.ts).
const Examples = registerComponent('Examples')
